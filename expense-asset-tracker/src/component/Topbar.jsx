...
//       <div className="flex items-center justify-between px-6 py-4">
//         {/* Search input */}
//         <div className="flex items-center px-3 py-2 rounded-md w-[50%]">
//           <Search className="text-black mr-2" size={20} />
//           <input
//             type="text"
//             placeholder="Search anything here"
...
// import userImg from "../assets/kob.jpg"; // Replace this with your image path
...
//           <span className="text-sm">Search anything here</span>
//         </div>
